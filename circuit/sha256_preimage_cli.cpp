...
using ethsnarks::sha256_preimage;
...
static int main_prove( int argc, char **argv )
{
    ...
    auto json = sha256_preimage_prove(pk_filename, input_buffer);
...
int main( int argc, char **argv )
{
    ...
    {
        return stub_main_genkeys<sha256_preimage>(argv[0], argc-1, &argv[1]);
    }
